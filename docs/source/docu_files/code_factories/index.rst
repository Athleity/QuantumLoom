...
Most of the codes are compatible with the standard code operations defined in :ref:`code_operations`, additionally, some codes provide extra operations specific to the code.
