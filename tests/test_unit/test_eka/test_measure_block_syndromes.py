...
class TestMeasureBlockSyndromes(unittest.TestCase):
    ...
    # def test_measureblocksyndromes_all_code_types(self):
    #     """
    #     Test that the MeasureBlockSyndromes operation works for all code types.
    #     """
    #     codes_and_lattices_to_test = (
    #         (
    #             BivariateBicycleCode.create(
    #                 dimensions=(6, 12),
    #                 a_exponents=[(3, 0), (0, 1), (0, 2)],
    #                 b_exponents=[(0, 3), (1, 0), (2, 0)],
    #                 # lattice=(lattice := Lattice.square_2d((10,10))),
    #                 unique_label="bbcode",
    #             ),
    #             Lattice.square_2d(),
    #             7,
    ...
    #         (
    #             Color488Code.create(
    #                 3, (lattice := Lattice.square_2d_2anc()), unique_label="color488"
    #             ),
    #             lattice,
    #             8,
    #         ),
    #         (
    #             Color666Code.create(
    #                 3, (lattice := Lattice.square_2d_2anc()), unique_label="color666"
    #             ),
    #             lattice,
    #             8,
    #         ),
    #         (
    #             FiveQubitPerfectCode.create(
    #                 lattice=(lattice := Lattice.poly_2d(n=5, anc=4)),
    #                 unique_label="5qpc",
    #             ),
    #             lattice,
    #             8,
    #         ),
    #         (
    #             HyperGraphProductCode.create(
    #                 (self.rep_code, self.rep_code),
    ...
    #                 5, "X", (lattice := Lattice.linear((6,))), unique_label="rep"
    #             ),
    #             lattice,
    #             2,
    #         ),
    ...
    #                 5, 5, (lattice := Lattice.square_2d((6, 6))), unique_label="rsc"
    #             ),
    #             lattice,
    #             4,
    #         ),
    #         (
    #             ShorCode.create(
    #                 lattice=(lattice := Lattice.linear()), unique_label="shor"
    #             ),
    #             lattice,
    #             8,
    #         ),
    #         (
    #             SteaneCode.create(
    #                 (lattice := Lattice.square_2d((5, 5))), unique_label="steane"
    #             ),
    #             lattice,
    #             8,
    #         ),
    ...
    #     for (code, lattice, n_interactions), n_cycles in product(
    #         codes_and_lattices_to_test,
    #         range(1, 6),
    #     ):
    #         meas_block_op = MeasureBlockSyndromes(code.unique_label,
    #                           n_cycles=n_cycles)
    #         input_eka = Eka(lattice, blocks=[code], operations=[meas_block_op])
    #         base_step = InterpretationStep(
    #             block_history=((code,),),
    #         )
    #         output_step = CodeApplicator(input_eka).apply(
    ...
    #         # Check that the output step is correct
    #         self.assertIsInstance(output_step, InterpretationStep)
    #         self.assertEqual(output_step.block_history[-1], (code,))
    #         self.assertEqual(
    #             output_step.intermediate_circuit_sequence[0][0].name,
    #             f"measure {code.unique_label} syndromes {n_cycles} time(s)",
    #         )
    #         self.assertEqual(
    #             output_step.intermediate_circuit_sequence[0][0].duration,
    #             n_cycles * (n_interactions + 4),  # 1 reset, 2 H, 1 measure
    #         )
