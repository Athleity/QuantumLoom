...
class TestCliffordSimClassicalRegister(unittest.TestCase):
    ...
    def test_invalid_register(self):
        """
        If the register is invalid, contains a value that is non-binary, a ValueError is
        raised. Invalid registers cannot be assigned to the `reg` attribute of Classical
